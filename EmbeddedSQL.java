...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         String query = "SELECT s.sname, COUNT(c.sid) FROM catalog c, suppliers s WHERE s.sid = c.sid GROUP BY s.sname";
        // System.out.print("\tEnter cost: $");
        // String input = in.readLine();
        // query += input;
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT s.sname, COUNT(c.sid) FROM catalog c, suppliers s WHERE s.sid =c.sid GROUP BY s.sname HAVING COUNT(c.sid)>2";
        // System.out.print("\tEnter cost: $");
        // String input = in.readLine();
        // query += input;
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "(SELECT s.sname, COUNT(c.sid) FROM suppliers s, catalog c, parts p WHERE s.sid = c.sid AND c.pid = p.pid AND p.color = 'Green' GROUP BY s.sname) EXCEPT (SELECT s.sname, COUNT(c.sid) FROM suppliers s, catalog c, parts p WHERE s.sid = c.sid AND c.pid = p.pid AND p.color != 'Green' GROUP BY s.sname)";
        // System.out.print("\tEnter cost: $");
        // String input = in.readLine();
        // query += input;
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT k.sname, MAX(C1.cost) FROM suppliers k, catalog c1 WHERE c1.sid = k.sid AND k.sname IN ((SELECT s.sname FROM suppliers s, catalog c, parts p WHERE s.sid = c.sid AND c.pid = p.pid AND p.color = 'Green' GROUP BY s.sname) INTERSECT (SELECT s.sname FROM suppliers s, catalog c, parts p WHERE s.sid = c.sid AND c.pid = p.pid AND p.color = 'Red' GROUP BY s.sname)) GROUP BY k.sname";
        //System.out.print("\tEnter cost: $");
        // String input = in.readLine();
        //query += input;
   ...
   public static void Query6(EmbeddedSQL esql){
      try{
         String query = "SELECT s.address FROM suppliers s, parts p, catalog c WHERE p.pid = c.pid AND c.sid = s.sid AND p.pname =";
